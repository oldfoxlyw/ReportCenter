          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table" id="listTableOverview">
                  <thead>
                    <tr>
                      <th>时间</th>
                      <th>总玩家角色数<a class="th-tips" href="#" data-content="所有已注册的帐号，包括试玩帐号" data-placement="top" data-toggle="popover" data-original-title="Tips"><img src="<?php echo base_url('resources/img/question.png'); ?>" /></a></th>
