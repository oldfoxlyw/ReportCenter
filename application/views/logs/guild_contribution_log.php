...
$(function() {
	...
	$("#btnSearch").click(function() {
		...
		$('#listTable').empty();
		$.post("<?php echo site_url('logs/guild_contribution_log/lists'); ?>", {
...
function onData(data) {
	...
	for(var i in json.data) {
		var row = [json.data[i].server_id, json.data[i].guid, json.data[i].role_id, json.data[i].action_name, json.data[i].current_contribution, json.data[i].spend_contribution, json.data[i].time, json.data[i].desc];
		aaData.push(row);
	}
