...
$(function() {
	...
	$("#btnSearch").click(function() {
		...
		$('#listTable').empty();
		$.post("<?php echo site_url('logs/experience_log/lists'); ?>", {
...
function onData(data) {
	...
	for(var i in json.data) {
		var row = [json.data[i].server_id, json.data[i].guid, json.data[i].role_id, json.data[i].action_name, json.data[i].target_type, json.data[i].target_id, json.data[i].total_experience, json.data[i].add_exp, json.data[i].time, json.data[i].desc];
		aaData.push(row);
	}
