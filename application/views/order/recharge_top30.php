                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div data-date="<?php echo date('Y-m-d', $current_time); ?>" class="input-append date datepicker">
                            <input type="text" id="date" name="date" value="<?php echo date('Y-m-d', $current_time); ?>"  data-date-format="yyyy-mm-dd" >
...
$(function() {
	...
	$("#btnSearch").click(function() {
		...
		$('#listTable').empty();
		$.post("<?php echo site_url('order/recharge_top30/lists/json'); ?>", {
