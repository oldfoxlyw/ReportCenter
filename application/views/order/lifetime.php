...
function onData(data) {
	...
	for(var i in json) {
		var row = [
            ...
            json[i].paid_count_1,
            json[i].paid_rate_1,
            json[i].recharge_amount_1,
            json[i].paid_count_2,
            json[i].paid_rate_2,
            json[i].recharge_amount_2,
            json[i].paid_count_3,
            json[i].paid_rate_3,
            json[i].recharge_amount_3,
            json[i].paid_count_4,
            json[i].paid_rate_4,
            json[i].recharge_amount_4,
            json[i].paid_count_5,
            json[i].paid_rate_5,
            json[i].recharge_amount_5,
            json[i].paid_count_6,
            json[i].paid_rate_6,
            json[i].recharge_amount_6,
            json[i].paid_count_7,
            json[i].paid_rate_7,
            json[i].recharge_amount_7,
            json[i].paid_count_14,
            json[i].paid_rate_14,
            json[i].recharge_amount_14,
            json[i].paid_count_30,
            json[i].paid_rate_30,
            json[i].recharge_amount_30,
            json[i].paid_count_60,
            json[i].paid_rate_60,
            json[i].recharge_amount_60,
            json[i].paid_count_90,
            json[i].paid_rate_90,
            json[i].recharge_amount_90,
            json[i].paid_count_180,
            json[i].paid_rate_180,
            json[i].recharge_amount_180,
        ];
		aaData.push(row);
	}
