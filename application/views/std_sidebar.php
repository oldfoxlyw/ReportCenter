...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"><a href="#"><i class="icon icon-file"></i><span>用户数据</span><span class="label label-important"><i class="icon icon-arrow-down"></i></span></a>
      <ul>
        <?php if(in_array('register_account', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'account/register_account'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('account/register_account'); ?>">服务器注册用户数</a></li><?php endif; ?>
        <?php if(in_array('modify_account', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'account/modify_account'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('account/modify_account'); ?>">改名用户数</a></li><?php endif; ?>
        <?php if(in_array('register_new_account', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'account/register_new_account'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('account/register_new_account'); ?>">新增注册用户</a></li><?php endif; ?>
        <?php if(in_array('modify_new_account', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'account/modify_new_account'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('account/modify_new_account'); ?>">新改名用户数</a></li><?php endif; ?>
        <?php if(in_array('active_account', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'account/active_account'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('account/active_account'); ?>">服务器活跃用户数</a></li><?php endif; ?>
        <?php if(in_array('pay_account', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'account/pay_account'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('account/pay_account'); ?>">服务器付费用户数</a></li><?php endif; ?>
        <?php if(in_array('flowover_account', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'account/flowover_account'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('account/flowover_account'); ?>">服务器流失用户数</a></li><?php endif; ?>
        <?php if(in_array('reflow_account', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'account/reflow_account'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('account/reflow_account'); ?>">服务器回流用户数</a></li><?php endif; ?>
        <?php if(in_array('flowover_account_detail', $permissionArray) || in_array('All', $permissionArray)): ?><li<?php if($page_name == 'account/flowover_account_detail'): ?> class="active"<?php endif; ?>><a href="<?php echo site_url('account/flowover_account_detail'); ?>">服务器流失用户详情</a></li><?php endif; ?>
      </ul>
    </li>
